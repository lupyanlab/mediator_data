...
#file name
file_name="processed_data/mediator_data_filtered.csv"
#file_name="processed_data/mediator_data_filtered_correct.csv"
new_file_name="processed_data/mediator_nameability_filtered.csv"
...
colNames=['trials','stimulus','number_responses', 'avg_words_per_response', 'percent_unique_words','percent_unique_lemmas', 'simpson_diversity','modal_agreement','modal_names','modal_response_agreement','modal_response']
